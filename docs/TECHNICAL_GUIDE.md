# CarVisionAI / Technical guide

[← Project overview](../README.md) · [Visual provenance](VISUALS.md)

Detailed workflows retained from the original README. Run commands from the repository root. Example measurements and manifests below are illustrative, not collected hardware results.
...
The repository's visualization extra is conditional on Python below 3.13. Use Python 3.10–3.12 for the documented viewer environment:
